describe("your regexes", function(){
  ...
  it("should match ip addresses", function(){
    ...
    var regex = /^(([1][0-9][0-9]|[0-9]{1,2}|[2]([0-4][0-9]|[5][0-5]))\.){3}([1][0-9][0-9]|[0-9]{1,2}|[2]([0-4][0-9]|[5][0-5]))$/;
  ...
  it("should detect nearby words", function(){
    ...
    var containsNearbyWords = function(haystack, needle){
      var regPattern = new RegExp(needle + "(\\W\\w+){1,3}\\W" + needle + "\\b");
      return regPattern.test(haystack);
    };
